import { getDepartments } from "@/actions/admin-actions";
    ...
    <div>
      <div className="page-header">
        <div className="flex justify-between items-center">
          ...
          <AdminDepartmentActions mode="create" />
        </div>
      </div>
      ...
      {departments.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {departments.map((dept, i) => (
            <div
              key={dept.id}
              className={`card animate-fade-in stagger-${(i % 4) + 1} opacity-0 flex justify-between items-center`}
            >
